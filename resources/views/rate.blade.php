    ...
    <style>
        * {
        ...
        .feedback {
            ...
            padding: 30px;
            border-radius: 10px;
            border: 5px solid rgb(5, 184, 244);
            display: -webkit-box;
            display: flex;
            -webkit-box-orient: vertical;
            -webkit-box-direction: normal;
        ...
        <div class="flex flex-col">
            ...
            @endif
                ...
                <a href="/user/profile/{{ $user->id }}"
                    class="bg-red-500 hover:bg-red-600 active:bg-red-700 transition p-2  rounded-md text-white text-center">
                    الغاء
                </a>
        </div>
    </div>
...
<form class="container" method="POST" action="rate" dir="rtl">
    @csrf
    <div class="feedback">
        <div class="rating">
        ...
        <button type="submit"
            class="mt-5 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 transition p-2 font-bold rounded-md text-white text-center">إرسال
            التقييم</button>
    </div>
</form>
<!-- partial -->
